...
private var motor : BP_CharacterMotor;

// Use this for initialization
function Awake () {
	motor = GetComponent(BP_CharacterMotor);
}
...
@script RequireComponent (BP_CharacterMotor)
@script AddComponentMenu ("Character/BP_Platform Input Controller")
